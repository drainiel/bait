...
BAIT is a mobile application for analyzing content credibility and help users to better understand personal finance. It pairs an Expo/React Native client with a Node.js backend that runs a pipeline of LLM-driven agents (claim extraction, bias detection, source credibility, final verdict) and exposes a voice interface via ElevenLabs and LiveKit.
